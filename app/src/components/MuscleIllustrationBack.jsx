  ...
  return (
    <svg width={size} height={size * 1.6} viewBox="0 0 200 320" style={{ display: 'block' }}>
      ...
      <path d="M126 190 Q132 208 130 230 Q126 244 116 246 Q110 238 112 218 Q113 200 118 190Z"
        fill={getMuscleColor('Glutes')} {...S} />
      {/* Glute split line */}
      <line x1="100" y1="190" x2="100" y2="246" stroke="#111" strokeWidth="0.5" />
      ...
      {/* Knees (back) */}
      <ellipse cx="80" cy="306" rx="10" ry="7" fill="#252525" stroke="#3a3a3a" strokeWidth="0.8" />
      <ellipse cx="120" cy="306" rx="10" ry="7" fill="#252525" stroke="#3a3a3a" strokeWidth="0.8" />
      ...
      {/* Outer body contour */}
      <path d="M74 66 Q56 72 46 92 Q36 118 38 160 Q40 192 42 222 Q44 244 48 282 Q54 310 68 340 Q74 346 82 342 Q84 322 80 306 Q76 272 76 248 L100 246 L124 248 Q124 272 120 306 Q116 322 118 342 Q126 346 132 340 Q146 310 152 282 Q156 244 158 222 Q160 192 162 160 Q164 118 154 92 Q144 72 126 66 Q114 60 100 58 Q86 60 74 66Z"
